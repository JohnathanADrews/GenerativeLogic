...
{
    /// <summary>
    /// Determines whether the left series is less than the right series.
    /// </summary>
    public class LessThanSeries : GenericComparisonCreator
    {
        ...
        public LessThanSeries(IHomogeneousWrapper<IOperandStateProvider> operandWrapper = null)
            : base(operandWrapper)
        {
        }
