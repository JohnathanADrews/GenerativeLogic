...
{
    /// <summary>
    /// Determines whether the left series is greater than or equal to the right series.
    /// </summary>
    public class GreaterThanOrEqualToSeries : GenericComparisonCreator
    {
        /// <summary>
        ...
        public GreaterThanOrEqualToSeries(IHomogeneousWrapper<IOperandStateProvider> operandWrapper = null)
            : base(operandWrapper)
        {
        }
    }
