...
{
    /// <summary>
    /// Determines whether the left series is not equal to the right series.
    /// </summary>
    public class NotEqualSeries : GenericComparisonCreator
    {
        /// <summary>
        ...
        public NotEqualSeries(IHomogeneousWrapper<IOperandStateProvider> operandWrapper = null)
            : base(operandWrapper)
        {
        }
    }
